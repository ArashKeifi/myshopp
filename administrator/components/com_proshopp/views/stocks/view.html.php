...
class ProshoppViewStocks extends JViewLegacy {
    ...
    protected function addToolBar(){
        ...
        JToolbarHelper::title(JText::_('COM_PROSHOPP_ADMIN_MANAGER_STOCKS'));
        ...
        if ($this -> canDo -> get('core.edit.state')) {
            JToolBarHelper::publishList('stocks.publish');
            JToolBarHelper::unpublishList('stocks.unpublish');
        }
