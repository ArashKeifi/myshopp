    ...
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div id="filter-bar" class="btn-toolbar">
            <div class="row">
                ...
                <div class="col-lg-1 pull-right hidden-phone">
                    <div class="btn-group">
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <table class="footable table table-stripped toggle-arrow-tiny default footable-loaded" data-page-size="15" id="itemList">
                            <thead>
