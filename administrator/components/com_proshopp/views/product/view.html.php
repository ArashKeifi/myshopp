 ...
 * Ola View
 */
class ProshoppViewProduct extends JViewLegacy
{
	/**
    ...
    public function display($tpl = null)
    {
     ...
     parent::display($tpl);
        ...
        protected function addToolBar() 
        {
        	...
        	: JText::_('COM_PROSHOPP_ADMIN_TYPE_EDIT'), 'Product');
        	JToolBarHelper::apply('product.apply',$isNew? JText::_('COM_PROSHOPP_ADMIN_TYPE_NEXT_STEP') : 'JTOOLBAR_APPLY');
            if(!$isNew){JToolBarHelper::save('product.save');};
