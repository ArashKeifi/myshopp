 ...
 * Ola View
 */
class ProshoppViewLocation extends JViewLegacy
{
	/**
    ...
    public function display($tpl = null)
    {
     ...
     parent::display($tpl);
        ...
        protected function addToolBar() 
        {
        	...
        	JToolBarHelper::title($isNew ? JText::_('COM_PROSHOPP_ADMIN_LOCATION_NEW')
        	: JText::_('COM_PROSHOPP_ADMIN_LOCATION_EDIT'), 'location');
