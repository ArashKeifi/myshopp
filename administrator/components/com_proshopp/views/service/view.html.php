 ...
 * Ola View
 */
class ProshoppViewService extends JViewLegacy
{
	/**
    ...
    public function display($tpl = null)
    {
     ...
     parent::display($tpl);
        ...
        protected function addToolBar() 
        {
        	...
        	JToolBarHelper::title($isNew ? JText::_('COM_PROSHOPP_ADMIN_SERVICE_NEW')
        	: JText::_('COM_PROSHOPP_ADMIN_SERVICE_EDIT'), 'type');
