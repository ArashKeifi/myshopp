jQuery(document).ready(function() {
    jQuery("#filer_input").filer({
        ...
        uploadFile: {
            url: "./components/com_proshopp/assets/upload/php/upload.php",
            data: {'dest':window.destnation},
            type: 'POST',
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            var file = file.name;
            jQuery.post('./components/com_proshopp/assets/upload/php/remove_file.php', {file: file,dest:window.destnation});
        },
        files : window.files,
        onEmpty: null,
        options: null,
