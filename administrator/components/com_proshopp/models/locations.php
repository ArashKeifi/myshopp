...
class ProshoppModelLocations extends JModelList
{
    protected $searchInFields = array('a.title');
    ...
    protected function getListQuery()
    {
        ...
        $query->select('a.id,a.title,a.published,a.path,a.level');
        $query->from($db->quoteName('#__shopp_location') . ' AS a');
        $query->where('a.id != 1');
