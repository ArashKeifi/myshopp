...
class ProshoppModelStocks extends JModelList
{
    ...
    protected function getListQuery()
    {
        ...
        $query->select('a.id,a.name,a.published,a.low_count,a.critical_count');
        $query->from($db->quoteName('#__shopp_stock') . ' AS a');
