...
class ProshoppModelMessages extends JModelList
{
    ...
    protected function getListQuery()
    {
        ...
        $query->select('a.id,a.title,a.published,a.type,a.title,a.body,a.params');
        $query->from($db->quoteName('#__shopp_message') . ' AS a');
